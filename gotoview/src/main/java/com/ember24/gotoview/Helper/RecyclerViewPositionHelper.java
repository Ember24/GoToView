            ...
            recyclerView.getViewTreeObserver().addOnGlobalLayoutListener(
                    new ViewTreeObserver.OnGlobalLayoutListener() {
                        ...
                        public void onGlobalLayout() {
                            child[0] = findOneVisibleChild(0, layoutManager.getChildCount(), false, true);
                        }
                    });
        }

        return child[0] == null ? RecyclerView.NO_POSITION : recyclerView.getChildAdapterPosition(child[0]);
    }
